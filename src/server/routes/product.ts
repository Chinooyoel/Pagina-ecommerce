...
// const {
// 	crearProducto,
// 	obtenerPerfilDelProductoPorId,
// 	borrarProductoPorId,
// 	actulizarProductoPorId,
// 	mostrarFormularioCrearProducto,
// 	mostrarFormularioParaActualizarProducto,
// 	mostrarTablaDeProductos,
// 	buscarProductosPorPalabras,
// 	subirImagenDelProducto,
// 	buscarProductosConFiltros,
// } = require('../controller/productoController')
// const router = express.Router()
// const { validarProducto } = require('../middleware/validations')
...
// // /producto/perfil/:id
// router.get('/perfil/:id', ProductsController.findById)
...
// router.get(
// 	'/admin/buscar/:palabra',
// 	AuthenticationMiddleware.verifyRole,
// 	ProductsController.findByWord,
// )
...
// router.get(
// 	'/buscar/palabra=:palabra/idcat=:idcat/idsub=:idsub/idmarca=:idmarca/orden=:orden/',
// 	ProductsController.findWithFilters,
// )
...
// router.post(
// 	'/create',
// 	[AuthenticationMiddleware.verifyAdminRole, validateProduct],
