...
exports.validarProducto = [
    ...
    check('descripcion', 'La descripcion excede lo maximo de caracteres permitidos (500)').isLength({max: 500}),
    check('codigo', 'El codigo excede lo maximo de caracteres permitidos (20)').isLength({max: 20}),
    check('garantia', 'La garantia excede lo maximo de caracteres permitidos (20)').isLength({max: 20})
]
