...
exports.validateProduct = [
	...
	check(
		'nombre',
		'El nombre excede lo maximo de caracteres permitidos (200)',
	).isLength({ max: 200 }),
	check(
		'descripcion',
		'La descripcion excede lo maximo de caracteres permitidos (1500)',
	).isLength({ max: 1500 }),
	check(
		'codigo',
		'El codigo excede lo maximo de caracteres permitidos (45)',
	).isLength({ max: 45 }),
	check(
		'garantia',
		'La garantia excede lo maximo de caracteres permitidos (45)',
	).isLength({ max: 45 }),
]
...
exports.validateLogin = [
	...
	check(
		'email',
		'El email excede lo maximo de caracteres permitidos (50)',
	).isLength({ max: 50 }),
	check(
		'password',
		'La password excede lo maximo de caracteres permitidos (15)',
	).isLength({ max: 15 }),
]
...
exports.validateRegister = [
	...
	check(
		'nombre',
		'El nombre excede lo maximo de caracteres permitidos (50)',
	).isLength({ max: 50 }),
	check(
		'email',
		'El email excede lo maximo de caracteres permitidos (50)',
