...
function funcionParaQueElArticuloSeOpaqueYAparezcaMasInfo() {
	let elementoInteractivo = document.getElementsByClassName(
		'producto__interaccionArticulo',
	)
...
function ocultarBotonAgregarProducto() {
	let botonAgregarProducto = document.getElementsByClassName(
...
function funcionMostrarYOcultarAyuda() {
	let botonMostrarYOcultar = document.getElementsByClassName(
		'articuloAyuda__botonMostrar',
	)
...
function funcionModal() {
	let abrirModalTelefonico = document.getElementsByClassName(
		'abrirModalTelefonico',
	)
	let abrirModalMediosDePago = document.getElementsByClassName(
		'abrirModalMediosDePago',
	)
	let abrirModalLogin = document.getElementsByClassName('abrirModalLogin')
	let abrirModalRegistrarse = document.getElementsByClassName(
	...
	agregarEventoAlBotonAbrirYCerrarModal(
		abrirModalMediosDePago,
		modalMediosDePago,
	)
